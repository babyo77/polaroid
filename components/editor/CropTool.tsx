  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-full max-w-3xl mx-4 overflow-hidden rounded-2xl bg-black/40 backdrop-blur-xl border border-white/10"
      >
        ...
        {/* Mobile Controls */}
        <div className="md:hidden top-10 absolute left-1/2 -translate-x-1/2">
          <MobileImageControls
            zoom={zoom}
            onZoomIn={() => setZoom((z) => Math.min(z + 0.1, 3))}
            onZoomOut={() => setZoom((z) => Math.max(z - 0.1, 1))}
